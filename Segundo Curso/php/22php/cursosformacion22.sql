...
--
DROP DATABASE IF EXISTS `cursosformacion22`;
CREATE DATABASE IF NOT EXISTS `cursosformacion22` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `cursosformacion22`;
