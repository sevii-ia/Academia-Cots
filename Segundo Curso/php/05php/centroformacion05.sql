...
--
-- Base de datos: `centroformacion05`
--
CREATE DATABASE IF NOT EXISTS `centroformacion05` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `centroformacion05`;
...
('GARCIA PEREZ', 'C/ VILLEGAS, 1', '965123456', '001', '21123456X', 'MANUEL', '03', '03', 'H'),
('PEREZ GARCIA', 'C/ VILLEGAS, 2', '965654321', '002', '21654321P', 'SANDRA', '02', '30', 'M'),
('ESPINOSA RAMOS', 'C/ VILLEGAS, 3', '965789456', '003', '21789456T', 'ANTONIO', '03', '46', 'H'),
('ROCA GARCIA', 'C/ VILLEGAS, 4', '965321789', '004', '21654789R', 'JOSE', '01', '03', 'H'),
('RAMOS ROCA', 'C/ VILLEGAS, 5', '965123457', '005', '21784596S', 'MARIA', '02', '46', 'M'),
