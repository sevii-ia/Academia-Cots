...
--
-- Base de datos: `centroformacion08`
--
CREATE DATABASE IF NOT EXISTS `centroformacion08` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `centroformacion08`;
