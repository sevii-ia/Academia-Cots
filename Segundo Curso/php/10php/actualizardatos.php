...
$codprov=$_GET['provincias'];
$sexo=$_GET['sexo'];

$seleccion1 = "UPDATE empleados SET dni='$dni', nombre='$nombre', apellidos='$apellidos', domicilio='$domicilio', municipio='$municipio', codprov='$codprov', sexo='$sexo' WHERE dni='$dni'";
