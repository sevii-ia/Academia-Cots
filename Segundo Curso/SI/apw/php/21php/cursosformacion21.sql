...
--
-- Base de datos: `cursosformacion21`
--
DROP DATABASE IF EXISTS `cursosformacion21`;
CREATE DATABASE IF NOT EXISTS `cursosformacion21` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `cursosformacion21`;
